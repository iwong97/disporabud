                            ...
                            <tbody>
                                <?php foreach ($data as $d) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($d->status_pembayaran == 'Belum diapprove'){
                                                echo "Menunggu Approve";
                                            } elseif ($d->status_pembayaran == 'Ditolak') {
                                                echo " Status Pending";
                                            } elseif ($d->status_pembayaran == 'Sudah dibayar' ) {
                                                echo "Sudah dibayar";
                                            } elseif ($d->status_pembayaran == 'Approve pembayaran' ) {
                                                echo "Sudah diapprove";
                                            } elseif ($d->status_pembayaran == 'Belum dibayar' ) { ?>
                                                <?php 
                                                    $now = now();
                                                ...
                                                ?>
                                                <a href="<?php 
                                                echo base_url() ?>c_disporabud/buktiPembayaran?bayar=<?php echo $d->id_transaksi ?>">
                                                    <button class="btn btn-sm btn-info">Upload</button>
                                                </a>
                                            <?php }} ?>
                                            
                                        </td>
                                        <td><?php echo $d->alasan_kasir ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
