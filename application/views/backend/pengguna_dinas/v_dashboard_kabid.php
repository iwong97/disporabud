    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a href="<?php echo base_url() ?>c_disporabud/index">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"> <?php echo $this->session->nama_lengkap ?></strong>
                             </span> <span class="text-muted text-xs block">Kepala Bidang SarPras </span> </span> </a>
                    </div>
                </li>
                <br>
                <li>
                ...
                <li>
                    <a href="<?php echo base_url() ?>c_disporabud/laporanKabid"><i class="fa fa-">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to Dashboard KABID</span>
                </li>
                ...
                <div class="col-sm-12">
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Jumlah Transaksi Prasarana per-Tahun </h5>
